...
def _make_specialist(encoder_name: str, decoder_channels: tuple,
    ...
    if "mit_b" in encoder_name:
        return SpecialistSegFormer(encoder_name, decoder_channels,
...
def pretrain(cfg: Config, snapshot_path: str):
    ...
    _is_segformer = "mit_b" in cfg.model.specialist_encoder
    init_lr = cfg.training.ssl_lr if _is_segformer else cfg.training.base_lr
    if _is_segformer:

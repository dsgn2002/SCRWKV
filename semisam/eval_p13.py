"""P13 test eval — measured-target consultation gate, 5% labels."""
...
model.load_state_dict(
    torch.load('snapshots/tut_5pct_consult_gt/best_model.pth',
...
print(f'\nP13 TUT test: dice={np.mean(dices):.4f}  iou={np.mean(ious):.4f}  '
